...
public class WeatherMapper {
    ...
    public CurrentWeatherDto toCurrentDto(WeatherRecord record) {
        ...
        return CurrentWeatherDto.builder()
                ...
                .temperature_2m(record.getTemperature()!= null ? record.getTemperature().doubleValue() : null)
                ...
                .windspeed_10m(record.getWindSpeed()!= null ? record.getWindSpeed().doubleValue() : null)
                .relativehumidity_2m(record.getHumidity())
